...
public class IndexListTester {
	...
	public static void main(String[] args) {
		...
		if (parm == 0 || parm == 1) {
			listTester("____________________________________________________________________________________________________________________\n" +
							"Testing the singly linked list (SLList): ",
					new LLIndexList<Integer>(new SLList<Integer>()));
		}//End of 1
		if (parm == 0 || parm == 2) {
			listTester("____________________________________________________________________________________________________________________\n" +
							"Testing the singly linked list (SFLList): ",
					new LLIndexList<Integer>(new SLFLList<Integer>()));
		}//End of 2
		if (parm == 0 || parm == 3){
			listTester("____________________________________________________________________________________________________________________\n" +
							"Testing the doubly linked list (DLDHDTList): ",
